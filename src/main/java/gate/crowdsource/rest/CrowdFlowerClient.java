...
public class CrowdFlowerClient {
  ...
  protected JsonNode post(String uri, String... formData) throws IOException {
    return request("POST", uri, formData);
  }

  protected JsonNode get(String uri) throws IOException {
    return request("GET", uri);
  }

  protected JsonNode request(String method, String uri, String... formData)
          throws IOException {
    ...
    try {
      return mapper.readTree(responseReader);
    } finally {
